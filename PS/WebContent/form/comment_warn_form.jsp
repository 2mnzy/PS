...
<meta charset="UTF-8">
<%
	int c = Integer.parseInt(request.getParameter("C_NUM"));
%>
<style>
form{height:100%}
...
<div class="jumbotron">
  ...
  <hr class="my-4">
  <c:set var="c" value="${cominfo}"/>
	<form action="warnComProcess.wa" method="post">
	 <div class="comment-content">
	 <br><br><br>
	 
	 <input type="text" name="id" value="${c.WM_ID}">
	 <input type="text" name="comnum" value="${c.WC_NUM}">
